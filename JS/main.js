...
function populateNav() {
    $("#nav").append('<nav class="navbar navbar-expand-lg navbar-dark" style="background: rgba(0,0,0,0)"><a class="navbar-brand" href="https://serjykalstryke.github.io"><i class="fas fa-dharmachakra"></i></a><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button><div class="collapse navbar-collapse" id="navbarSupportedContent"><ul class="navbar-nav mr-auto"><li class="nav-item active"><a class="nav-link" href="https://serjykalstryke.github.io">Home <span class="sr-only">(current)</span></a></li><li class="nav-item"><a class="nav-link" href="https://www.github.com/serjykalstryke">Github</a></li><li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Portfolio Sample</a><div class="dropdown-menu" aria-labelledby="navbarDropdown"><a class="dropdown-item" href="https://serjykalstryke.github.io/deep-cuts/">Pitch</a><a class="dropdown-item" href="https://serjykalstryke.github.io/Weather-App/">weatherBot1.0</a><a class="dropdown-item" href="https://serjykalstryke.github.io/javascript-quiz/">Quiz Application</a><div class="dropdown-divider"></div><a class="dropdown-item" href="aboutMe.html">About Me</a></div></li><li class="nav-item"></nav>')
